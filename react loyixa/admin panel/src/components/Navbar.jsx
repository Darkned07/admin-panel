...
function Navbar() {
  ...
  return (
    <div className="razmer__navbar  mt-[10px] shadow-xl bg-white rounded-[16px] text-neutral-content flex flex-row items-center justify-between p-[16px] ">
